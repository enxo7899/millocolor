  ...
  return (
    <section className="py-20 relative z-10">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {/* Main content card */}
          <div className="bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              {/* Icon */}
              <motion.div
                className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-millo-red to-millo-blue rounded-full mb-8"
